...
\begin{figure}[htbp]
	\centering
	\includegraphics[width=0.65\linewidth]{finetune_stage1_curves.png}
	\caption{Stage 1 convergence at 9.61 BPM validation MAE (31 epochs).}
	\label{fig:stage1_curves}
\end{figure}

\begin{figure}[htbp]
	\centering
	\includegraphics[width=0.65\linewidth]{finetune_predictions.png}
	\caption{Sample predictions on Apple Watch test set showing improved accuracy.}
	\label{fig:predictions}
\end{figure}

\begin{figure}[htbp]
	\centering
	\includegraphics[width=0.65\linewidth]{finetune_stage2_curves.png}
	\caption{Stage 2 overfitting validates conservative Stage 1 approach.}
